...
>(
  (
    ...
    // For mobile, we use "open" or "closed", for desktop we use "expanded" or "collapsed"
        ...
        <div
          className={cn(
            ...
            state === "collapsed" && collapsible === "icon"
              ...
              : "w-[var(--sidebar-width)]",
            state !== "collapsed" && "group-data-[collapsible=offcanvas]:w-0"
          )}
        />
        <div
          className={cn(
  ...
  return (
    <main
      ...
      className={cn(
        ...
        // When sidebar variant is inset we add outer margins (unused in our layout),
        // but for the standard sidebar we just add a small left margin when collapsed.
